...
const End: React.FC<EndProps> = ({ data }) => {
  return (
    <div className="flex flex-col px-20 pt-12 pb-20 bg-white max-md:px-5 h-screen border border-solid rounded">
      ...
      <div className="border border-solid rounded h-screen">
        <div className="border border-solid rounded w-full self-center text-xl flex bg-gray-800 hover:bg-gray-700 h-[60px] items-center">
          <h2 className="text-xl justify-center items-center">{data}</h2>
          <div className="flex items-center space-x-4 ml-[300px]">
            <button
              type="button"
